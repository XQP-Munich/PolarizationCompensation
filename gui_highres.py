...
class Gui(QWidget):
    ...
    def initUI(self):
        ...
        for i in range(4):
            ...
            laserLayout.addWidget(self.canvases[i], 0, 0, 6, 1)
            laserLayout.addWidget(self.canvases[i + 4], 7, 0, 6, 1)
            laserLayout.addWidget(aliceSettingsGroup, 13, 0)
            laserGroup.setLayout(laserLayout)

            self.gridlayout.addWidget(laserGroup, 1, i, 15, 1)
        ...
        self.gridlayout.addWidget(statisticsGroup, 16, 0, 1, 4)
